...
public class PasswordEncryption {
	public static boolean authenticate(String attemptedPassword, String encryptedPassword, String salt) {
		try {
			return authenticate(attemptedPassword, toByteArray(encryptedPassword), toByteArray(salt));
		}
	...
	public static String encryptPassword(String password, String salt) {
		try {
			return toHexString(getEncryptedPassword(password, toByteArray(salt)));
		}
		catch (NoSuchAlgorithmException e) { throw new RuntimeException(e);} 
		catch (InvalidKeySpecException e) { throw new RuntimeException(e);}
	}
	...
	public static String createSaltString() { 
		try {
			return toHexString(generateSalt());
		}
		catch (NoSuchAlgorithmException e) { throw new RuntimeException(e);}
	}
